...
import {deleteProduct, setProductCurrentPage, setProductModalType, setProductModalVisible,} from "./msProductSlice";
import {useDispatch, useSelector} from "react-redux";
import {exportExcel} from "../../../config/lib/exportExcel";

const MsProductToolkit = ({form}) => {
...
export default MsProductToolkit;