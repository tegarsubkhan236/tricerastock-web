...
import {deleteUser, fetchDetailUsers, setUserFilter, setUserModalType, setUserModalVisible} from "./coreUsersSlice";
import {Debounce} from "../../config/helper/debounce";
import {exportExcel} from "../../config/lib/exportExcel";

const CoreUsersToolkit = ({form}) => {
...
export default CoreUsersToolkit;